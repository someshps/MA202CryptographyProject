...
#------------------------------------------------------------------------------------------------------------------------------
#Code snippet to convert an image into ascii art
import PIL.Image
...
plt.title("Number of iterations per 10 characters - Image Conversion")
...
plt.title("Time taken per 10 characters - Image Conversion")
plt.xlabel("Number of Characters")
